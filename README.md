...
- `:matches-css-after(arg)`: [[uBO reference]](https://github.com/gorhill/uBlock/wiki/Procedural-cosmetic-filters#subjectmatches-css-afterarg)
- `:matches-css-before(arg)`: [[uBO reference]](https://github.com/gorhill/uBlock/wiki/Procedural-cosmetic-filters#subjectmatches-css-beforearg)
- `:matches-css(arg)`: [[ADG reference]](https://github.com/AdguardTeam/ExtendedCss#extended-css-matches-css), [[uBO reference]](https://github.com/gorhill/uBlock/wiki/Procedural-cosmetic-filters#subjectmatches-cssarg)
